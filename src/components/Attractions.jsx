...
function Attractions() {
  ...
  // Memoized attractions list (prevents recreation on every render)
  const attractions = useMemo(
    () => [
      ...
      },
      {
        ...
        description:
          "Historic fort with active lighthouse & stunning sea views (~5–10 min).",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqkPWzr5Dd5pxxM32vG_CtIkyoDWZDe4QTig&s",
        type: "fort",
        distance: "very-close",
      },
      {
        ...
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRP856-QQl-gaLHwhGUEtGwQRxxD91lSchGew&s",
        type: "fort",
        distance: "mid-range",
      },
      {
      ...
      },
      {
        ...
        description:
          "Pristine long white-sand beach, very clean & peaceful (~10 min drive).",
        image:
          "https://dynamic-media-cdn.tripadvisor.com/media/photo-o/2c/2e/29/2d/caption.jpg?w=700&h=400&s=1",
        type: "beach",
        distance: "very-close",
      },
      {
        ...
        image:
          "https://www.shutterstock.com/image-photo/colourful-sky-devgad-beach-during-260nw-1467138248.jpg",
        type: "beach",
        distance: "day-trip",
      },
      {
        ...
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQKwt1Vt3Agfleeffc2e_XzB_5RBNMVVDq_Jw&s",
        type: "temple",
        distance: "day-trip",
      },
    ],
  ...
  return (
    <section className="attractionsContainer" aria-labelledby="attractions-title">
      <div className="title-filter-options-block">
        <h2 id="attractions-title" className="title">
      ...
      <div className="grid">
        {filteredAttractions.map((attr) => (
          <Link
            key={attr.slug}
            to={`/attractions/${attr.slug}`}
            className="card"
            aria-label={`View details about ${attr.title}`}
          >
            <img
              src={attr.image}
              alt={attr.title}
